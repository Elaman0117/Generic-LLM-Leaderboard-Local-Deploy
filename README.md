...
|---|------|---------|---------|-----------|--------|------|------|
| 1 | Kimi K3 (max) | 0.8632 | 2800B | 104B | large | Y | N |
| 2 | GLM-5.2 (max) | 0.7835 | 753B | 40B | large | Y | N |
| 3 | MiniMax-M3 | 0.7213 | 428B | 23B | large | Y | N |
| 4 | DeepSeek V4 Flash 0731 (Reasoning, Max Effort) | 0.7080 | 284B | 13B | large | Y | N |
| 5 | Inkling Small | 0.6375 | 266B | 12B | large | Y | N |
| 6 | Qwen3.6 27B (Reasoning) | 0.6011 | 28B | 28B | small | Y | N |
...
| 10 | G9v3-3B | 0.3127 | 3B | 3B | tiny | Y | N |
